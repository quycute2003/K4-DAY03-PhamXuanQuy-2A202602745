...
class MCPAcademicServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        # --------------------------------------------------------------------------
        # Thực thi Tool Call và đóng gói kết quả theo chuẩn MCP JSON-RPC
...
if __name__ == "__main__":
    ...
    # Kiểm tra trạng thái Task 1.2 (Tool Schema)
    ...
    if not test_result:
        print("⏳ [TASK 2.1]: Hàm call_tool() đang trả về rỗng và cần được hoàn thiện trong 'src/mcp_server.py'!")
    else:
